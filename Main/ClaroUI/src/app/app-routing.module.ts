...
/*claro componenst */
import { NegotiationComponent } from "./claro/negotiation/negotiation.component";
import { LoginComponent } from "./claro/login/login.component";
import { RegisterComponent } from "./claro/register/register.component";
import { ForgotPasswordComponent } from "./claro/forgot-password/forgot-password.component";
import { RouteGuard } from "./claro/services/routing/route-guard.service";
import { ExistingnegotiationsComponent } from "./claro/existingnegotiations/existingnegotiations.component";
...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'claro/negotiation',
        canActivate: [RouteGuard],
        component: NegotiationComponent
      },
      {
        path: 'claro/existingnegotiations',
        canActivate: [RouteGuard],
        component: ExistingnegotiationsComponent
      },
      {
